...
public:
    ...
    crow::response handle_batch_create_folders(const crow::request& req);
    ...
    crow::response handle_batch_delete_folders(const crow::request& req);
    crow::response handle_batch_hard_delete_folders(const crow::request& req);
